...
class BezierView @JvmOverloads constructor(
    ...
    private fun calculateInner() {
        ...
        innerArray[1] = PointF((bezierX - bezierInnerWidth + 244), bezierInnerHeight + extra)
        innerArray[2] = PointF(bezierX - bezierInnerWidth + 242, bezierInnerHeight + extra)
        innerArray[3] = PointF(bezierX - bezierInnerWidth + 241, height - 38)
        innerArray[4] = PointF(bezierX, height - 35)
        innerArray[5] = PointF(bezierX + bezierInnerWidth - 241, height - 38)
        innerArray[6] = PointF(bezierX + bezierInnerWidth - 242, bezierInnerHeight + extra)
        innerArray[7] = PointF(bezierX + bezierInnerWidth - 244, bezierInnerHeight + extra)
